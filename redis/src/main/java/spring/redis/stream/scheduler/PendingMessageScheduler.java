package spring.redis.stream.scheduler;
...
import spring.redis.stream.util.RedisOperator;
...
public class PendingMessageScheduler implements InitializingBean {
    ...
    @Scheduled(fixedRate = 10000) // 10초 마다 작동 -thread하나 비동기로 빠진다.
    public void processPendingMessage(){
        // Pending message 조회 (동기방식)
        ...
        for(PendingMessage pendingMessage : pendingMessages){
            ...
            try{
                ...
                MapRecord<String, Object, Object> messageToProcess = this.redisOperator
                        .findStreamMessageById(this.streamKey, pendingMessage.getIdAsString()); //pending된 message의 id를 찾는다.
    ...
    public void afterPropertiesSet() throws Exception {
        this.streamKey = "my-stream";
        this.consumerGroupName = "lee_grp";
        this.consumerName = "lee";
    }
}